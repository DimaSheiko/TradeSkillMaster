...
function private:CreateButtons(parent)
	...
	local button = TSMAPI.GUI:CreateButton(frame, 18, "TSMAuctioningStopRestartButton")
...
function GUI:CreateSelectionFrame(parent)
	...
	local postBtn = TSMAPI.GUI:CreateButton(frame, 16, "StartPostScan")
	...
	local cancelBtn = TSMAPI.GUI:CreateButton(frame, 16, "StartCancelScan")
	...
	local resetBtn = TSMAPI.GUI:CreateButton(frame, 16, "StartResetScan")
